...
/*   Updated: 2021/03/31 00:19:33 by srorscha         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	a->pl.moves = a->pl.bmoves * a->kbuf.shift *
		(a->prs.res_x + a->prs.res_y) / 200;
	a->pl.rots = a->pl.brots * (a->prs.res_x + a->prs.res_y) / 200;
